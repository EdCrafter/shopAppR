import type { PostDeleteData, PostFormData, PostsState } from "./postSlice";

const API_URL = "http://localhost:3000"; // URL of your Rails API server
...
export async function fetchPosts() {
  return fetch(`${API_URL}/posts.json`, {
    ...
    // .then(
    //   () => console.log("Fetching posts from /posts.json")
    // ) 
    .catch((error) => {
